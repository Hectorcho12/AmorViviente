Public Class Rpt_Dez_miembro
    Public conexion As New Conexiones
    Dim miembro As Integer
    Private Sub Rpt_Dez_miembro_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        ' Me.Reportes_Diezmos_MTableAdapter.Fill(Me.Amor_VivienteDataSet1.Reportes_Diezmos_M)
