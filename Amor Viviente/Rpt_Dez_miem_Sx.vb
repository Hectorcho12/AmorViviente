Public Class Rpt_Dez_miem_Sx
    Public conexion As New Conexiones
    Dim miembro As Integer
    Private Sub Rpt_Dez_miem_Sx_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: esta línea de código carga datos en la tabla 'Amor_VivienteDataSet1.Reportes_Diezmos_MSX' Puede moverla o quitarla según sea necesario.
        Me.MdiParent = Inicio
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        Me.Reportes_Diezmos_MSXTableAdapter.Fill(Me.Amor_VivienteDataSet1.Reportes_Diezmos_MSX, miembro, desde.Text, hasta.Text)
