Public Class Rpt_Ofr
    ...
    Private Sub cbxzona_SelectedIndexChanged(sender As Object, e As EventArgs)
        Me.Sec_Mostrar_CBXTableAdapter.Fill(Me.Amor_VivienteDataSet1.Sec_Mostrar_CBX, cbxzona.Text)
    End Sub
